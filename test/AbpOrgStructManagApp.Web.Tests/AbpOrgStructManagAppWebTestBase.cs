...
{
    public abstract class AbpOrgStructManagAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AbpOrgStructManagAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AbpOrgStructManagAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AbpOrgStructManagAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AbpOrgStructManagAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AbpOrgStructManagAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AbpOrgStructManagAppDbContext, Task<T>> func)
        {
            T result;
